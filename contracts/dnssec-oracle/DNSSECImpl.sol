...
contract DNSSECImpl is DNSSEC, Owned {
     ...
     */
    function submitRRSet(RRSetWithSignature calldata input, bytes calldata proof)
        public override
     ...
     *        applies to.
     */
    function deleteRRSet(uint16 deleteType, bytes calldata deleteName, RRSetWithSignature calldata nsec, bytes calldata proof)
        public override
    {
